...
const GeoPanel: React.FC = () => {
  ...
  const updateGeo = useBuilderStore((state) => state.updateGeo)
  const geo = page?.schema.geo || { aiSummary: '', aiKeyFacts: [], enabled: true, aiTone: 'factuel' }
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            {(geo.aiKeyFacts || []).map((fact: string, index: number) => (
